...
class TradingBotAPI(Client):
    ...
    def signal_orders_algo_pending(self, algoOrdType = 'contract'):
        params = {'algoOrdType': algoOrdType}
        return self._request_with_params(GET, SIGNAL_ORDERS_ALGO_PENDING, params)

    # GET /api/v5/tradingBot/signal/close-position
    def signal_close_position(self, instId = '', algoId = ''):
        params = {'instId': instId, 'algoId': algoId, 'tag': '4868e962b08bSUDE'}
